...
urlpatterns = [
    ...
    path('plan/<int:plan_id>/send-plan-to-hod', send_to_hod_for_verification, name='send_to_hod_for_verification'),
    # path('plan/<int:plan_id>/correction/create', add_plan_correction, name='add_plan_correction'),
    path('plan/<int:plan_id>/hod-approve-and-send-to-pdu', hod_verify_and_send_to_pdu, name='hod_verify_and_send_to_pdu'), # check: planning_submission_deadline
